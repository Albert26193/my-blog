...
- 想要将力扣上面的内容直接以 `markdown` 的形式复制下来
- 调研了一些插件，发现多少都不太满意
- 后来找到一个美区力扣的复制插件，无法在国区工作，所以直接基于此插件，折腾一个脚本。
    ...
    const TARGETS = [
      {
        ...
        descriptionDom: document.querySelector('[data-track-load=description_content]'),
        useStyle: true,
        style: `
        position: absolute;
        top: 1rem;
      ...
      },
      {
        ...
        useStyle: false,
        style: '',
        classList: ['mt-1', 'inline-flex', 'min-h-20px', 'items-center', 'space-x-2', 'align-top']
      },
      {
        name: 'contestLayout',
        titleDom: document.querySelector(
        ...
        descriptionDom: document.querySelector('div.question-content.default-content'),
        useStyle: true,
        style: `display: flex;`,
        classList: []
      },
    ...
    `
      ...
      buttons.forEach((button) => {
        ...
        _button.addEventListener('click', () => {
          ...
          setTimeout(() => (_button.innerText = BUTTON_MAP[button].text), BUTTON_ACTION_WAIT_TIME)
        })
